...
var watchSymbols = ["quality", "quantity","apples", "oranges","good", "bad","day", "night","left", "right"];
...
var t = new twitter({
    consumer_key: 'yourTwitterData',           // <--- FILL ME IN
    consumer_secret: 'yourTwitterData',        // <--- FILL ME IN
    access_token_key: 'yourTwitterData',       // <--- FILL ME IN
    access_token_secret: 'yourTwitterData'     // <--- FILL ME IN
});
